...
export function QualityCard({ ticker, section }: Props) {
  ...
  return (
    ...
    <section className="rounded-md border border-strata-border bg-strata-surface p-5">
      ...
      {/* 3 MetricRings — bail to em-dash when value missing. */}
      <div className="mb-5 grid grid-cols-3 gap-3 border-y border-strata-line py-5">
        <MetricRing
          label="ROE"
          value={rings.roe !== null ? formatClaimValue(rings.roe) : "—"}
          ratio={rings.roe}
          accentClass="text-strata-quality"
        />
        <MetricRing
          label="ROIC TTM"
          value={rings.roic !== null ? formatClaimValue(rings.roic) : "—"}
          ratio={rings.roic}
        ...
        <MetricRing
          label="FCF margin"
          value={
            rings.fcfMargin !== null ? formatClaimValue(rings.fcfMargin) : "—"
          }
      ...
      {series.length >= 2 && (
        <div className="mb-5">
          <div className="mb-2 font-mono text-[10px] uppercase tracking-kicker text-strata-quality">
            Margin trends
          </div>
